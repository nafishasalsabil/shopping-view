      ...
      <div className="right-features">
        ...
        <div className="product-container">
          {visibleProducts.map((item, index) => {
            ...
            return (
              <Link
                className="link-to-anything-feat"
                to={`/products/${encodeURIComponent(JSON.stringify(item))}`}
              >
                <div key={index} className="each-product">
                  ...
                  <div className="rating-stock">
                    <div className="rating">
                      <div
                        className={`stars rating-${Math.round(item.rating)}`}
                      >
                        {item.rating}
                      </div>
                    </div>
                  ...
                  <div className="price-container">
                    ...
                    <span className="pres-price">${item.price}</span>
                  </div>
                </div>
              </Link>
            );
